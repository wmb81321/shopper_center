...
const quickRules = [
  {
    icon: "⚡",
    title: "Responde en menos de 2 min",
    desc: "Cada minuto que pasa, la probabilidad de cierre baja un 10%. El lead está caliente AHORA.",
  },
  {
    icon: "🎯",
    title: "Siempre cierra pidiendo datos",
    desc: 'Nunca termines un mensaje sin una pregunta o un call to action. Nunca digas "cualquier cosa me escribes".',
  },
  {
    icon: "🔒",
    title: 'Usa "te lo aparto"',
    desc: "Crea urgencia real. El cliente siente que puede perder la oportunidad. Funciona porque es verdad — se agotan.",
  },
  {
    icon: "💳",
    title: "Repite CONTRAENTREGA",
    desc: "Es tu arma más poderosa. Elimina el miedo. Repítelo en cada mensaje clave: \"pagas cuando te llega\".",
  },
  {
    icon: "🚫",
    title: "No negocies precio",
    desc: "El precio YA tiene descuento. Muestra el ahorro vs precio regular. Si insisten, ofrece combo como alternativa.",
  },
  {
    icon: "📋",
    title: "Copia y pega, no improvises",
    desc: "Los scripts están diseñados para convertir. Personaliza el nombre y producto, pero no cambies la estructura.",
  },
];
...
export default function PlaybookVentas() {
  const [activeStage, setActiveStage] = useState("bienvenida");
  const [activeTab, setActiveTab] = useState("funnel");
  const current = funnelStages.find((s) => s.id === activeStage);

  return (
    <div style={{ background: COLORS.bg, minHeight: "100vh", color: COLORS.text, fontFamily: "'SF Pro Display', -apple-system, 'Segoe UI', sans-serif" }}>
      {/* Header */}
        ...
        {activeTab === "reglas" && (
          <div>
            ...
            <div style={{ marginTop: "24px", background: `${COLORS.accent}10`, border: `1px solid ${COLORS.accent}30`, borderRadius: "10px", padding: "20px" }}>
              <h3 style={{ margin: "0 0 12px", fontSize: "15px", color: COLORS.accent }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "24px" }}>
              {metrics.map((m, i) => (
                ...
                >
                  <div style={{ fontSize: "28px", fontWeight: 800, color: m.color, marginBottom: "6px" }}>
                    {m.value}
                  </div>
            ...
            <div style={{ background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: "10px", padding: "20px" }}>
              <h3 style={{ margin: "0 0 16px", fontSize: "15px", color: COLORS.text }}>
            ...
            <div style={{ marginTop: "16px", background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: "10px", padding: "20px" }}>
              <h3 style={{ margin: "0 0 12px", fontSize: "15px", color: COLORS.text }}>
                💰 Proyección con 10 Leads/Día
              </h3>
